...
__(Q1)__ When you suggest methods to deal with missing values to users, the recurrent question is â€œWhat is the percentage of missing values which is acceptable in my data set? Is 50% too much but 20% OK?â€? What is your answer to this question?
...
```{r data}
don <-read.csv("D:/course/grade four/MAP573 DA/MAP573-Group9/Data/Load_History.csv")
head(don)
```
...
```{r}
library(dplyr)
load_history <-read.csv("D:/course/grade four/MAP573 DA/MAP573-Group9/Data/Load_History.csv")
res.MIPCA <- read.csv("D:/course/grade four/MAP573 DA/MAP573-Group9/MIPCA&ameliaz/MIPCAres.csv")
res.amelia <- read.csv("D:/course/grade four/MAP573 DA/MAP573-Group9/MIPCA&ameliaz/ameliares.csv")
...
```{r}
res.MIPCA.z1 <- read.csv("D:/course/grade four/MAP573 DA/MAP573-Group9/MIPCA&ameliaz/MIPCAresz1.csv")


MIPCA1_1l <- as.vector(t(res.MIPCA.z1[,4:27]))
plot(MIPCA1_1l[(10320-240):(10320+240)],type="l", colorRampPalette("blue"))
```
...
res.amelia.z1 <- read.csv("D:/course/grade four/MAP573 DA/MAP573-Group9/MIPCA&ameliaz/ameliaz1res.csv")
